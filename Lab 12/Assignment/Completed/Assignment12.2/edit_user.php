...
if(isset($_POST['sub'])) {
	...
	$q = "UPDATE USER SET USER_TITLE='$title', USER_FNAME='$firstname', USER_LNAME='$lastname', USER_GENDER='$gender', 
		  USER_EMAIL='$email', USER_NAME='$username', USER_PASSWD='$passwd', USER_GROUPID='$usergroup', DISABLE='$disabled' 
		...
		<div id="div_main">
			...
			<div id="div_content" class="form">
				...
				while($row = $result->fetch_array()) {
					...
					if($row['DISABLE'] == 1)
						echo "CHECKED='CHECKED' ";
					echo "type='checkbox' name='disabled' value='1'>";
